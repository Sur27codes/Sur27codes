...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=20&duration=2200&pause=650&color=7B9EFF&center=true&vCenter=true&width=760&lines=Building+LLMs+%26+RAG+Systems+from+scratch+🤖;Voice+AI+·+Agentic+Workflows+·+FastMCP+🔥;Real-Time+ML+%7C+33%25+accuracy+gains+%7C+MLOps+📈;FastAPI+%7C+Next.js+%7C+Docker+%7C+AWS+⚡;MS+Data+Science+%40+Stony+Brook+🎓;Turning+coffee+into+deployed+AI+☕+→+🚀;Open+to+AI%2FML+Engineer+%26+Applied+Scientist+roles+✨)](https://git.io/typing-svg)
...
[![🎲 ROLL THE DICE](https://img.shields.io/badge/🎲_%20ROLL%20THE%20DICE-0d2a0d?style=for-the-badge)](https://github.com/Sur27codes/Sur27codes/issues/new?title=dice%7Croll&labels=dice&body=Rolling+the+dice+🎲)
